...
export function loadTextElementsFromSnapshot(textData)
{
  ...
  innerText.addEventListener('input', () =>
  {
    ...
    const theCanvasDesignSurface = domStation.theCanvasDesignWrapper
    const scrollTop = theCanvasDesignSurface.scrollTop
    const scrollLeft = theCanvasDesignSurface.scrollLeft
    ...
    theCanvasDesignSurface.scrollTop = scrollTop
    theCanvasDesignSurface.scrollLeft = scrollLeft
  })
